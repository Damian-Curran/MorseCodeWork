...
namespace MorseCode
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            this.Frame.Navigate(typeof(InformationPage), null);
        }
        ...
        private void Button_Tapped_3(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(TeachingPage), null);
        }
    }
}
